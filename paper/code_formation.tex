...
A speculative but intriguing application concerns the interface between oscillatory field dynamics and neural spiking. Consider the beta-gamma coupling observed in cortex: beta oscillations ($\sim$15--30 Hz) modulate the amplitude of nested gamma oscillations ($\sim$30--100 Hz), which in turn coordinate spike timing.
